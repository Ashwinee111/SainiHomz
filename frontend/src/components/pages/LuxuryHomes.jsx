...
import Image1 from "../../assets/luxuryhomesbanner.jpg";
    ...
    const fetchProperties = async () => {
      try {
        ...
        const apartments = response.data.filter(
          (property) => property.property_type === "Luxury Homes"
        );
    ...
    <div className="pt-16 font-primary">
      ...
      >
        ...
        <p className="text-xl md:text-2xl mt-6 z-10">
          Home / <span className="text-[#A5A8B1]">Luxury Homes</span>
        </p>
      ...
      <div className="max-w-[1500px] mx-auto px-4 py-8">
        {loading ? (
          ...
          <p className="text-center text-xl font-semibold text-red-500">
            No Luxury Homes available at the moment.
          </p>
        )}
      </div>
    </div>
