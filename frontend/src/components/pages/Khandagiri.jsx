...
import Image1 from "../../assets/khandagiri.jpg";
...
const Khandagiri = () => {
  ...
  return (
    <div className="pt-16 font-primary">
      ...
      >
        <h2 className="text-4xl md:text-6xl font-bold z-10">Khandagiri</h2>
        <p className="text-xl md:text-2xl mt-6 z-10">
          Home / <span className="text-[#A5A8B1]">Khandagiri</span>
        </p>
